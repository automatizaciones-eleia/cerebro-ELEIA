...
export const AUTH_USER = "cerebro_user";
export const AUTH_TOKEN = "cerebro_authToken";
export const AUTH_TIMESTAMP = "cerebro_authTimestamp";
export const COMPLETE_QUESTIONNAIRE = "cerebro_completed_questionnaire";
export const SEEN_DOC_PIN_ALERT = "cerebro_pinned_document_alert";
export const SEEN_WATCH_ALERT = "cerebro_watched_document_alert";
export const LAST_VISITED_WORKSPACE = "cerebro_last_visited_workspace";
export const USER_PROMPT_INPUT_MAP = "cerebro_user_prompt_input_map";
export const PENDING_HOME_MESSAGE = "cerebro_pending_home_message";

export const APPEARANCE_SETTINGS = "cerebro_appearance_settings";
